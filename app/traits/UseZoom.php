...
trait UseZoom
{
    ...
    {
        $apiKey = "oIv3gDiuQxGZq6VgVY7sHg";
        $apiSecret = "8iuzSfXTVtbgppZ79LyjbvLwPadkH9lV";
        $account_id = "nebmYmzMTEe8UaS7yopdLA";
        ...
        $response = $client->post('https://zoom.us/oauth/token?grant_type=account_credentials&account_id=nebmYmzMTEe8UaS7yopdLA', [
            'form_params' => [
                'client_id' => $apiKey,
    ...
    public function create($data)
    {
        ...
        $url = 'https://api.zoom.us/v2/users/usersvu@outlook.com/meetings';
        // dd( $data->start_at.':00Z');
        $response = Http::withToken($accessToken)->post($url, [
            'topic'      => $data->topic,
            'type'       => 2,
            // 'timezone' => 'Africa/Cairo',
            'start_time' => $data->start_at.':00Z',
